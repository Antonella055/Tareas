 ...
 * @author Antonella
 */
public class PokemonAJuego extends javax.swing.JFrame {
     public String PokemonJuego;
    /**
     * Creates new form ElegirPok
     */
    public PokemonAJuego() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Con que Pokemon deseas jugar?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PokemonAJuego.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PokemonAJuego().setVisible(true);
            }
        });
    }
