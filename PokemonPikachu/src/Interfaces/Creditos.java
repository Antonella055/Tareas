...
public class Creditos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Album name: GBA Pokémon Ruby & Sapphire Music Super Complete (2003) Song name: Hideout  ");

        jLabel4.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Album name: GBA Pokémon Ruby & Sapphire Music Super Complete (2003) Song name: Rune City");

        jLabel5.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Album name: GBA Pokémon Ruby & Sapphire Music Super Complete (2003) Song name: Heavy Rain");

        jLabel6.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Album name: GBA Pokémon Ruby & Sapphire Music Super Complete (2003) Song name: Ocean Science Museum");

        jLabel7.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Album name: GBA Pokémon Ruby & Sapphire Music Super Complete (2003) Song name: Minamo City");

        jLabel8.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Repositorio de sprites Mundo Misterioso");

        jLabel9.setFont(new java.awt.Font("OCR A Extended", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Artista: Betatus Perfil de DeviantArt: https://www.deviantart.com/betatus");
...
class Fondo extends JPanel{
        ...
        public void paint(Graphics g){
            imagen= new ImageIcon(getClass().getResource("/Images/creditos.png")).getImage();
